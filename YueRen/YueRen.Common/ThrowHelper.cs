...
namespace YueRen.Common
{
    ...
    public static class ThrowHelper
    {
        ...
        {
            if (!Array.Exists(boundArray, delegate(int x) { return x == argument; }))
                throw new ArgumentOutOfRangeException(name, string.Format("[{0}]", StringEx.Join("],[", boundArray)));
        }
        /// <summary>
        /// 超界    判断
        /// </summary>
        ...
        {
            if (!Array.Exists(boundArray, x => x == argument))
